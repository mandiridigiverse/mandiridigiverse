...
<body>
    <div class="container">
        ...
        <div class="isi-surat">
            <div class="pembuka">
                <p>
                    Bersama dengan surat ini kami, Mandiri Digital Universe menyampaikan Surat Peringatan III terkait
            ...
            <div class="pemberitahuan">
                ...
                <p>
                    Kesan kami terhadap @if ($pegawai->jk != 'Wanita')
                        {{ 'Saudara ' . $pegawai->nama }}@else{{ 'Saudari' . $pegawai->nama }}@endif . Anda seorang Pegawai yang baik selama bekerja di Mandiri Digital Universe, dalam hal
                    ini kami ingin memberikan contoh yang nyata bagi semua Pegawai MDU supaya dapat mengemban
            ...
            <div class="penutup">
                <p>
                    Demikian Surat Peringatan III ini dan pemberhentian hubungan kerja ini. Kami dari pihak MDU
