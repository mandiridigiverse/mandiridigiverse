                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                ...
                                                Bapak/Ibu
                                                {{ $details['atasan'] }} yang
                                                merupakan Atasan Bapak/Ibu pada {{ date('d-M-Y H:i ') }}

                                                <br>
                                                @if ($details['keputusan'] == 'Disetujui')
                                                    <p><em>Selanjutnya adalah menunggu keputusan dari HRD</em></p>
                                                @else
                                                    <p><em>Untuk keterangan lebih lanjut silahkan hubungi Atasan
                                                            yang berkaitan dengan pengajuan cuti ini.</em></p>
                                                @endif
